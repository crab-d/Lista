...
<body>
    ...
    <header class="sticky top-0 header-bg flex items-center fix z-20">
    ...
    <section class="h-full w-full  ">
        ...
        <div class="w-full relative h-max p-10 bg-fixed flex justify-center items-center">
            ...
            <div class="absolute inset-0 bg-cover bg-center filter blur-md z-0 bg-fixed"
                style="background-image: url('{{ asset('image/bg-lp.png') }}');"></div>
        ...
        <div class="w-full flex flex-col md:flex-row justify-center h-full m-0 items-center bg-light ">
            ...
            <div class="w-3/4 max-w-4xl sm:p-5 md:p-10 h-max flex flex-col md:flex-row items-center justify-center">
                <p class="text-1xl sm:w-full md:w-1/2 text-justify p-5 text-gray-500">Lista is a powerful and intuitive
                    note-taking platform designed to help you stay organized and productive. Whether you're a student,
                    professional, or just someone who loves to jot down ideas, Lista provides a seamless experience for
                    capturing, organizing, and accessing your notes from anywhere. With an easy-to-use interface,
                    advanced search features, and the ability to sync across devices, Lista ensures your notes are
                    always at your fingertips. Take control of your thoughts, tasks, and projects with Lista – your
                    go-to digital notebook.</p>
                <p class="text-1xl sm:w-full md:w-1/2 text-justify p-5 text-gray-500">Lista is a powerful and intuitive
                    note-taking platform designed to help you stay organized and productive. Whether you're a student,
                    professional, or just someone who loves to jot down ideas, Lista provides a seamless experience for
                    capturing, organizing, and accessing your notes from anywhere. With an easy-to-use interface,
    ...
    <section class="h-full w-full p-10 bg-gray-200 flex flex-wrap justify-center">
        ...
        <div class="h-full w-full p-10 flex flex-wrap justify-center">
            <x-card class="border" title="Sync Across Devices"
            ...
            <x-card title="Organize Your Notes"
                content="Stay organized with Lista’s intuitive interface, and easily search your notes."
                imageUrl="{{ asset('image/notepadVector.png')}}" />
            <x-card title="Collaborate with Ease"
                content="Share your notes and collaborate in real-time for group projects."
                imageUrl="{{ asset('image/notepadVector.png')}}" />
        </div>
    </section>
    <section class="bg-gray-800 p-20 flex flex-col justify-center bg-fixed relative">

        {{-- <div class="absolute inset-0 filter blur-md bg-fixed"
            style="background-image: url({{ asset('image/bg-lp.png')}})"> </div>
        <div class="relative z-10"> --}}
            ...
            <form method="POST" action="" class=" w-full flex flex-wrap justify-between">
                ...
                <textarea type="text" class="bg-white p-2 w-full md:w-7/12 text-wrap rounded-sm"
                    placeholder="Message"></textarea>
                <div class="flex flex-col w-full md:w-4/12">
                    <input type="email" class="bg-white p-2 w-full h-max mt-10 rounded-sm md:mt-0"
                        placeholder="Email" />
                    <input type="email" class="bg-white p-2 w-full h-max mt-10 rounded-sm md:mt-5"
                        placeholder="Subject" />
